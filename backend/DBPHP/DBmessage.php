...
class DBmessage extends DBcommon
{
    ...
    // -------------------- delete_profile.php --------------------
    public function DeleteMessage($prof_id)
    {
        // prof_idに対応したmessageデータを削除
        $result = $this->ExecuteUpdate("DELETE FROM message WHERE prof_id = ?", [$prof_id]);
